    ...
    feverExplosion[#feverExplosion+1] = Def.ActorFrame{
        ...
        FeverScoreMessageCommand=function(self,params)
            if params.Amount > self.prevAmount and not self.feverActive then
                self:stoptweening():x(self.startPos):z(8):diffuse(color(FHColorTable["Fret 6"])):decelerate(math.random(30,100) / 100):z(math.random(60,90)):x(self.startPos+math.random(-100,100)):rotationz(math.random(-179,179)):diffusealpha(0)
...
if sButton == "Strum Up" then
    return Def.ActorFrame{
        Def.ActorFrame{ --Fever meter take 2
            ...
            Def.Model{ --Filling
                OnCommand=function(self)
                    self:diffuse(color(FHColorTable["Fret 6"])):zoomx(2.04):zoomy(2.04):zoomz(0)
                    self.Active = false
                    self.Amount = 0
                end,
                Meshes="models/meter.txt",
            ...
            Def.Sprite{--low cap Sprite
                ...
                InitCommand=function(self)
                    self:blend('BlendMode_Add'):zoomy(.4):zoomx(.25):rotationz(-90):rotationx(-90):z(90):diffuse(Alpha(color(FHColorTable["Fret 6"]),0)):diffusealpha(0):y(-3)
                    self.Active = false
                    self.Amount = 0
                end,
                FeverMessageCommand=function(self,params)
            ...
            Def.Sprite{--Top cap Sprite
                Texture='sprites/feversprite1.png',
                InitCommand=function(self)
                    self:blend('BlendMode_Add'):zoomy(.4):zoomx(.25):rotationz(90):rotationx(-90):diffuse(Alpha(color(FHColorTable["Fret 6"]),0)):diffusealpha(0):z(90)
                    self.Active = false
                    self.Amount = 0
                end,
                FeverMessageCommand=function(self,params)
        ...
        Def.ActorFrame{ --Highway
            ...
            Def.Quad{ --Highway edges
                ...
                FeverMessageCommand=function(self,params)
                    if params.pn ~= sPlayer then return end
                    if params.Active then
                        self:diffuse(color(FHColorTable["Fret 6"])):diffusetopedge(Alpha(color(FHColorTable["Fret 6"]),0))
                    else
            ...
            Def.ActorFrame{ --Fever effects
                ...
                Def.Sprite{
                    Texture="sprites/feversprite1.png",
                    InitCommand=function(self)
                        self:x(-102):diffuse(color(FHColorTable["Fret 6"])):zoom(4)
                    end
                },
                Def.Sprite{
                    Texture="sprites/feversprite1.png",
                    InitCommand=function(self)
                        self:x(102):zoomx(-4):zoomy(4):diffuse(color(FHColorTable["Fret 6"]))
                    end
                },
                FeverMessageCommand=function(self,params)
                    if params.pn ~= sPlayer then return end
            ...
            Def.ActorFrame{ --More fever effects
                ...
                Def.Quad{
                    InitCommand=function(self)
                        self:x(-150):zoomto(32,1100):diffuse(Alpha(color(FHColorTable["Fret 6"]),0)):diffuselowerleft(color(FHColorTable["Fret 6"]))
                    end
                },
                Def.Quad{
                    InitCommand=function(self)
...
local Push = Def.ActorFrame{
    ...
    Def.Model {
        InitCommand=function(self)
            self:diffuse(color(FHColorTable[sButton])):diffusealpha(0):rotationx(90):rotationy(120 + offsetChart[sButton]):zoom(1.01)
...
return Def.ActorFrame {
    ...
    Def.Model {
        InitCommand=function(self) self:rotationx(90):diffuse(color(FHColorTable[sButton])):zoom(0.99) end,
