...
for i = 1,15 do
    HoldExplosion[#HoldExplosion+1] = Def.ActorFrame{
        ...
        Def.ActorFrame {
            ...
            Def.Sprite {
                InitCommand=function(self)
                    self:diffuse(color(RSQColorTable["192nd"])):diffusealpha(0.5):zoom(1.3):blend('BlendMode_Add'):SetAllStateDelays(0.0625)
                end,
                Texture='sprites/spark 4x1.png'
            }
        }
    ...
    Def.ActorFrame {
        ...
        Def.ActorFrame {
            ...
            Def.Sprite {
                ...
                InitCommand=function(self)
                    self:diffuse(color(RSQColorTable["192nd"])):zoom(0.8):blend('BlendMode_Add')
                end
            },
            HoldingOnCommand=function(self)
                self:diffusealpha(1):pulse():effectclock("timer"):effectmagnitude(0.6,1,0.6):effectperiod(0.2)
